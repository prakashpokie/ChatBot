...
const ConversationList:React.FC<ConversationListProps> = ({
    ...
    useEffect(() =>{
        ...
        const removeHandlee =( conversation: FullConversationType) => {
            setItems((current) => {
        ...
        pusherClient.bind('conversation:remove', removeHandlee);

        return () => {
            pusherClient.unsubscribe(pusherKey);
            pusherClient.unbind('conversation:new', newHandler);
            pusherClient.unbind('conversation:update', updateHandler);
            pusherClient.unbind('conversation:remove', removeHandlee);
        }
